...
class AnnotateTest(unittest.TestCase):
    ...
    def testAnnotate(self):
        results = get_annotations('This is some text with a quote, like "Help me" which was said by Rahul Bhargava')
    ...
    def testNoQuotes(self):
        results = get_annotations('This is some text with no quotes all all. Move along. Nothing to see here')
        assert 'sentences' in results
